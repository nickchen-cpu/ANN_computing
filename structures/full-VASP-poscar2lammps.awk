...
BEGIN{
  ...
  for(k=1;k<=ntypes;k++){
    for(i=1;i<=type[k];i++){
      ...
      if (k == "1" || k == "4" )                printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,0, k,0, xx,yy,zz;
      else if (xx>(lx/2)&&yy>(ly/2)&&zz>(lz/2)) printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,1, k,0, xx,yy,zz;
      else if (xx>(lx/2)&&yy>(ly/2)&&zz<(lz/2)) printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,2, k,0, xx,yy,zz;
      else if (xx>(lx/2)&&yy<(ly/2)&&zz<(lz/2)) printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,3, k,0, xx,yy,zz;
      else if (xx>(lx/2)&&yy<(ly/2)&&zz>(lz/2)) printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,4, k,0, xx,yy,zz;
      else if (xx<(lx/2)&&yy>(ly/2)&&zz>(lz/2)) printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,5, k,0, xx,yy,zz;
      else if (xx<(lx/2)&&yy<(ly/2)&&zz>(lz/2)) printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,6, k,0, xx,yy,zz;
      else if (xx<(lx/2)&&yy<(ly/2)&&zz<(lz/2)) printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,7, k,0, xx,yy,zz;
      else if (xx<(lx/2)&&yy>(ly/2)&&zz<(lz/2)) printf"%4i %i %s %-4i %-10.12f %10.12f %1.12f\n",iatom,8, k,0, xx,yy,zz;
    }
  }
